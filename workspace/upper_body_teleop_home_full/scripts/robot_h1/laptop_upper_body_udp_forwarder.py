#!/usr/bin/env python3
"""Forward upper_body_msgs/UpperBodyCommand from laptop ROS 2 to H1 robot over UDP.

Run inside the laptop camera container, where /upper_body/command_geom is published.
The robot-side receiver is sdk2_h1_udp_lowcmd_sender.
"""
import math
import socket
import struct
...
# C++ struct: uint32_t magic; uint32_t seq; double stamp_sec; float q[8]
PACK_FMT = "<IId8f"
