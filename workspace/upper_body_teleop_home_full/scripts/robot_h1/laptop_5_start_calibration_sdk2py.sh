...
echo "============================================================"
echo " LAPTOP 5: START CALIBRATION FOR REAL H1"
echo "============================================================"
...
echo "Publishing calibration command..."
ros2 topic pub --once /upper_body/start_calibration std_msgs/msg/Bool "{data: true}"

echo
echo "Done. Watch retarget terminal for:"
echo "  Calibration complete. Teleoperation enabled."
'
