...
def main():
    ...
    model_name = cfg.get("double_cameras", {}).get("triangulation_backend", "opencv_triangulatePoints")
    ...
    print("stereo_triangulation template project prepared.")
    print("Next steps:")
    print("1) implement left/right 2D pose extraction")
    print("2) implement stereo triangulation")
    print("3) export unified metrics and common schema")
