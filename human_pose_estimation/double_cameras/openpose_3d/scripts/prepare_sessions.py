...
REQUIRED = ["left.mp4", "right.mp4", "calib/intrinsics_left.yaml", "calib/intrinsics_right.yaml", "calib/extrinsics.yaml", "calib/stereo.yaml"]
...
def main():
    ...
    print("Checking stereo sessions...")
