...
def main():
    ...
    model_name = cfg.get("model", {}).get("model_name", "openpose_3d_reconstruction")
    ...
    print("openpose_3d template project prepared.")
    print("Next step: integrate real OpenPose 3D reconstruction and export results into common schema.")
