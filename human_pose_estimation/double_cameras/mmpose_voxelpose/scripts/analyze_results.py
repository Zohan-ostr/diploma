...
def main():
    ...
    save_bar(labels, [to_float(r["left_upper_arm_abs_error_m_mean"]) for r in rows], "Arm abs error by stereo session", "Abs error (m)", out_dir / "arm_abs_error_by_session.png")
